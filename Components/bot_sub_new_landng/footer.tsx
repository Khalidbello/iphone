        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-12">
          ...
          <div className="bg-gradient-to-r from-blue-700 to-cyan-600 rounded-3xl p-10 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl">
            ...
            <button
              ...
              className="group relative px-10 py-4 bg-white text-blue-700 rounded-full font-semibold text-lg flex items-center gap-2 hover:scale-105 transition-all shadow-lg"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mt-20">
            ...
            <div>
              ...
              <p className="mt-4 text-gray-400 leading-relaxed text-sm">
                BotSub helps you buy data, airtime, and pay bills instantly —
                even without an active internet connection. Built for speed,
